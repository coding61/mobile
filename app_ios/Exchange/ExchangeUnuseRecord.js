...
class ExchangeUnuseRecord extends Component {
	constructor(props) {
	    super(props);
    ...
    _fetchCommodityRecordList(pagenum){
		...
		var dic = {
              ...
              "member_number": 1,
              "leader": {},
              "taken_time": "2017-10-18T10:06:21.129728"
        }
        var array = [];
    ...
    _renderItemCommodity(item, index){
        return (
            <View style={styles.item}>
                ...
                <TouchableOpacity onPress={this._useProduct.bind(this, item)} style={{borderColor:themeColor, borderWidth:1, borderRadius:15, paddingHorizontal:20, backgroundColor:'white'}}>
                    <Text style={{fontSize:font3, color:themeColor, height:25, lineHeight:23}}>{"使用"}</Text>
                </TouchableOpacity>
            </View>
        )
    }
...
const btnLineColor = Utils.underLineColor;
...
export default ExchangeUnuseRecord;
