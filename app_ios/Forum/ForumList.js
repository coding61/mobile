...
export default class ForumList extends Component{
    ...
    rendertop(top){
        ...
        if(top=='Top10'){
            return(<Image style={{width:50,height:20,}} source={require('../assets/Forum/top10.png')}/>)
        }
        if(top=='Top50'){
            return(<Image style={{width:50,height:20,}} source={require('../assets/Forum/top50.png')}/>)
        }
        if(top=='Top100'){
            return(<Image style={{width:50,height:20,}} source={require('../assets/Forum/top100.png')}/>)
        }
    }
    renderForumRow(item){
