...
export default class VideoPlayScreen extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      videoUrl: this.props.navigation.state.params.videoUrl?this.props.navigation.state.params.videoUrl:"",
      videoCover: this.props.navigation.state.params.videoCover?this.props.navigation.state.params.videoCover:"https://resource.bcgame-face2face.haorenao.cn/videoCover.png",
