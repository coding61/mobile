...
const ExchangeRecordTab = 1;    //加入活动的选项
const RewardRecordTab = 0;      //发布活动的选项
    ...
    _fetchCommodityRecordList(pagenum){
        ...
        */
        ...
        Utils.isLogin((token)=>{
            if (token) {
                var type = "get",
                    url = Http.getExchangeOrderList(pagenum),
                    token = token,
                    data = null;
    	...
    	return (
    		<View style={{flex:1}}>
                ...
                <View style={styles.tabs}>
                    <TouchableOpacity onPress={()=>{this.setState({tab:ExchangeRecordTab})}} style={[styles.tab, this.state.tab===ExchangeRecordTab?styles.tabSelectView:styles.tab]}>
                    <View><Text style={this.state.tab===ExchangeRecordTab?styles.tabSelectText:styles.tabText}>兑换记录</Text></View>
                    </TouchableOpacity>
                    ...
                    <View><Text style={this.state.tab===RewardRecordTab?styles.tabSelectText:styles.tabText}>中奖纪录</Text></View>
                    </TouchableOpacity>
                </View>
                */}
                {
